...
function MeScene() {
    ...
    return (
        <Canvas>
            ...
            <OrbitControls maxPolarAngle={Math.PI / 2} enableZoom={false} enableDamping={false} enableRotate={false} />
            <Scroll models={modelURLs} currentScene={currentScene} setCurrentScene={setCurrentScene} />
